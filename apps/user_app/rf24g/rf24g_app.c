...
{
    syscfg_write(CFG_USER_PAIR_DATA, (u8 *)(&rf24g_pair[0]),
                 sizeof(rf24g_pair_t));
}

void read_rf24g_pair_data(void)
{
    syscfg_read(CFG_USER_PAIR_DATA, (u8 *)(&rf24g_pair[0]),
                sizeof(rf24g_pair_t));
...
void rf24_key_handle()
{
    ...
    if (rf24_T0 > 15 && rf24_T1 < 1) {
        ...
        if (key_value == RF24_K01 || key_value == RF24_K02 ||
            key_value == RF24_K03 || key_value == RF24_K04) {
